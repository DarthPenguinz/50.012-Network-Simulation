...
commands = [
    ...
    'python3 cluster.py 1 2 0.01 False',
    'python3 cluster.py 2 2 0.01 False',
    'python3 cluster.py 3 2 0.01 False',
    'python3 cluster.py 4 2 0.01 False',
    'python3 cluster.py 5 2 0.01 False',
    'python3 main.py 0.01 100 False'
]
